<aside class="sidebar bg-dark text-white" id="sidebar" style="width: 250px;">
    ...
    <nav class="p-2 p-md-3" style="padding-bottom: 100px;">
        ...
        <a href="{{ route('admin.advances.index') }}" class="nav-link text-white d-flex align-items-center mb-2 rounded {{ request()->routeIs('admin.advances.*') ? 'bg-primary' : 'hover-bg-secondary' }}" style="padding: 0.5rem;" onclick="closeSidebarOnMobile()">
            <i class="bi bi-cash-stack me-2"></i>
            <span>Avanslar</span>
        </a>
        
        <a href="{{ route('admin.finance.transactions.index') }}" class="nav-link text-white d-flex align-items-center mb-2 rounded {{ request()->routeIs('admin.finance.*') ? 'bg-primary' : 'hover-bg-secondary' }}" style="padding: 0.5rem;" onclick="closeSidebarOnMobile()">
    ...
    <div class="position-fixed bottom-0 p-2 p-md-3 border-top border-secondary bg-dark" style="width: 250px; z-index: 1051;">
        @auth
