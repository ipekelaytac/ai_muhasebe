...
@section('title', 'Yeni Mesai')
@section('page-title', 'Yeni Mesai')
@section('page-subtitle', 'Yeni bir mesai ekleyin')
    ...
    <div class="col-md-10">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.overtimes.store') }}" id="overtimeForm">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
