...
@section('page-title', 'Alacak Yaşlandırma')
@section('page-subtitle', 'Vade durumuna göre alacaklar')

@section('content')
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('accounting.reports.receivables-aging') }}" class="row g-3">
            <div class="col-md-4">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                ...
                                <p class="text-muted mb-0">Alacak bulunmuyor</p>
                            </td>
                        </tr>
                    @endforelse
