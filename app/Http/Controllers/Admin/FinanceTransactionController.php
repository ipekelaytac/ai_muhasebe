...
class FinanceTransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        $categories = FinanceCategory::where('company_id', $user->company_id)
            ->active()
            ->get();
        
        return view('admin.finance.transactions.create', compact('branches', 'categories'));
    }
    ...
    public function edit(FinanceTransaction $transaction)
    {
        ...
        return view('admin.finance.transactions.edit', compact('transaction', 'branches', 'categories'));
    }
    ...
    public function reports(Request $request)
    {
        ...
        $transactions = $query->with(['category', 'branch', 'attachments'])->get();
